...
| 下一轮 Alpha | Local 和网络稳定性 | Local embedded UDP server、Open to LAN 初步支持、jitter buffer、Local/Remote/LAN demo 脚本 |
| Beta 音频 | 可用音频链路 | Opus 编解码、丢包隐藏、语音激活优化、持久化音量控制 |
| Beta 空间 | 可解释空间效果 | OpenAL backend、服务端权威位置、距离衰减平滑、基础遮挡和低通 |
