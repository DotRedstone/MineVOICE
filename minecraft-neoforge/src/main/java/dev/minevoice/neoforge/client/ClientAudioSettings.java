...
public record ClientAudioSettings(
    ...
    private static ClientAudioSettings copy(
            ...
            boolean nameplateIconsEnabled, int hudIconSize, DebugInfoLevel debugInfoLevel, boolean debugRenderRays, int groupMemberColor, int outOfSightIndicatorMode, int occludedIndicatorMode, boolean hrtfEnabled) {
        return new ClientAudioSettings(
                ...
                nameplateIconsEnabled, hudIconSize, debugInfoLevel, debugRenderRays, groupMemberColor, outOfSightIndicatorMode, occludedIndicatorMode, hrtfEnabled
        );
    }
